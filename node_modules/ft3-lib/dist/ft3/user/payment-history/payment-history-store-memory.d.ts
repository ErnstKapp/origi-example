...
export default class PaymentHistoryStoreMemory implements PaymentHistoryStore {
    ...
    save(blockchainId: Buffer, accountId: Buffer, paymentHistoryEntries: PaymentHistoryEntry[]): void;
    saveSyncInfo(blockchainId: Buffer, accountId: Buffer, syncInfo: any): void;
    deletePaymentHistory(accountId: Buffer, blockchainId: Buffer): void;
    private paymentHistoryKey;
    private syncInfoKey;
}
